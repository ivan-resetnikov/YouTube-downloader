...
class Application :
    def __init__ (self) :
        self.root = Tk()
        self.root.title('Youtube downloader | V1.2')
        self.root.resizable(0, 0)
        self.root.iconphoto(0, PhotoImage(file='theme\\icon.png'))
    ...
    def run (self) :
        ...
        # partreon support
        icon = ImageTk.PhotoImage(Image.open('theme\\patreon.png'))
        Button(self.root, image=icon, command=lambda:system('start https://www.patreon.com/user?u=84122364')).grid(row=4, column=2)
